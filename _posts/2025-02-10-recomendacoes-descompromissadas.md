...
* [AJULIACOSTA - O que a Julia vai
ser?](https://www.youtube.com/watch?v=plSeqVn_mxU). Julia segue dando o nome.
clipe foda.
...
* [grandson - INERTIA](). o rage against the machine da nossa geração. muitas
...
* [(2014) Visualizing Algorithms](https://bost.ocks.org/mike/algorithms/).
  (inglês) post
